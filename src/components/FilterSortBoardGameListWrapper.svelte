<script lang="ts">
	...
	// Constanten voor sliders
	const MAX_PLAYTIME_DISPLAY = 360; // Max waarde voor de slider UI (kan hoger zijn in data)
		...
		<div class="space-y-1">
			...
			<div class="flex gap-2 items-center">
				...
				<input
					...
					class="w-full accent-blue-600 slider-range"
				/>
			</div>
			<div class="flex gap-2 items-center">
		...
		<div class="space-y-1">
			...
			<div class="flex gap-2 items-center">
				...
				<input
					...
					class="w-full accent-red-600 slider-range"
				/>
			</div>
			<div class="flex gap-2 items-center">
...
<style>
	.sort-button.active {
		/* Styling zit nu in Tailwind classes hierboven */
	}
	...
	/* Verbeter focus state voor sliders */
